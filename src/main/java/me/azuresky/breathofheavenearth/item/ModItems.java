...
public class ModItems {
    ...
    public static final RegistryObject<Item> BREATHSTONE = ITEMS.register("breathstone",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
    ...
    public static final RegistryObject<Item> ELEMENTAL_TESTER = ITEMS.register("elemental_tester",
            () -> new ElementalTesterItem(new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
    ...
    public static final RegistryObject<Item> BREATHCRYSTAL_SWORD = ITEMS.register("breathcrystal_sword",
            () -> new FreezeSwordItem(ModTiers.BREATHCRYSTAL,4,3f,
                    new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
    ...
    public static final RegistryObject<Item> SOUL_EVIL = ITEMS.register("soul_evil",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
    public static final RegistryObject<Item> SOUL_NEUTRAL = ITEMS.register("soul_neutral",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
    public static final RegistryObject<Item> SOUL_GOOD = ITEMS.register("soul_good",
            () -> new Item(new Item.Properties().tab(ModCreativeModeTab.BREATH_TAB_ITEMS)));
